function renderValue(value, dark) {
  ...
  return (
    <p style={{ color: textColor, fontFamily: "'Play', monospace", fontSize: "0.88rem" }}>
      {String(value)}
    </p>
  );
}
    ...
    >
      <div style={{
        ...
        background: dark
          ...
          : "linear-gradient(90deg, transparent, #c0427a, transparent)",
        opacity: 0.5,
      }} />
      ...
      <h2 style={{
        ...
        textShadow: dark ? "0 0 8px #00ff4144" : "none",
        display: "flex",
        alignItems: "center",
        gap: "0.5rem",
      }}>
